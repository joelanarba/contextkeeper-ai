      ...
      <div className="max-w-5xl mx-auto w-full flex-1 flex flex-col">
        <header className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Manage all your actionable items.</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="flex-1 flex items-center justify-center">
            <EmptyState 
              ...
              className="w-full max-w-md py-24 border border-dashed border-border rounded-2xl"
            />
          </div>
        ) : view === 'list' ? (
          <div className="space-y-8">
            {todoTasks.length > 0 && (
              <section>
                <h2 className="text-sm font-semibold text-zinc-500 uppercase tracking-wider mb-3">To Do ({todoTasks.length})</h2>
            ...
            {doneTasks.length > 0 && (
              <section className="opacity-60">
                <h2 className="text-sm font-semibold text-zinc-500 uppercase tracking-wider mb-3">Done ({doneTasks.length})</h2>
                <div className="grid grid-cols-1 gap-3">
          ...
          <div className="flex-1 grid grid-cols-2 gap-6 items-start">
            ...
            <div className="bg-zinc-50/50 p-4 rounded-xl border border-zinc-100">
              <h2 className="text-sm font-semibold text-zinc-700 mb-4 flex items-center justify-between">
            ...
            <div className="bg-zinc-50/50 p-4 rounded-xl border border-zinc-100 opacity-75">
              <h2 className="text-sm font-semibold text-zinc-700 mb-4 flex items-center justify-between">
